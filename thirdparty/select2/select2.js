    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            ...
            var container = $(document.createElement("div")).attr({
                ...
                //"<a href='javascript:void(0)' onclick='return false;' class='select2-choice' tabindex='-1'>", //修改前代码（修改后支持设置高度）
                "<a href='javascript:void(0)' onclick='return false;' class='select2-choice' tabindex='-1'" + (opts.height? (" style='height:" + opts.height + "'"): '')+  ">",
